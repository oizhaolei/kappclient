 ...
 * system|signature) and only granted on K-App's install in the following
 * cases:
 * <ul>
 * <li>On all Android versions if K-App is pre-deployed as a
...
public class SystemInstaller extends Installer {
     ...
     * {@link android.content.pm.IPackageInstallObserver} by
     * {@link #installPackage(android.net.Uri, android.content.pm.IPackageInstallObserver, int)} on
     * success.
     */
     ...
     * Installation return code: this is passed to the
     * {@link android.content.pm.IPackageInstallObserver} by
     * {@link #installPackage(android.net.Uri, android.content.pm.IPackageInstallObserver, int)} if
     ...
     * {@link android.content.pm.IPackageDeleteObserver} by {@link #deletePackage()} if the system
