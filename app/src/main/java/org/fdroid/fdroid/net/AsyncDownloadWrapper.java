...
/**
 * Given a {@link Downloader}, this wrapper will conduct the download operation on a
 * separate thread. All progress/status/error/etc events will be forwarded from that thread to the thread
 * that {@link org.fdroid.fdroid.net.AsyncDownloadWrapper#download()} was invoked on. If you want to respond with UI feedback
